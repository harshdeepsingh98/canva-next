...
import { ActionContainer, ButtonContainer, IconContainer } from 'styles/views/dashboard'
import Image from 'next/image'
import Plus from 'images/png/AddCircle.png'
import MenuIcon from 'images/png/Menu.png'
import { DataType } from 'utils/customHooks/dashboard'
...
export const dataSource: DataType[] = Array.from<DataType>({ length: 46 }).map<DataType>(
  (_, i) => ({
    key: i,
    ...
    Action: (
      <ActionContainer>
        ...
        <IconContainer>
          <Image src={MenuIcon} alt="MenuIcon" width={20} height={20} />
        </IconContainer>
      </ActionContainer>
    )
  })
